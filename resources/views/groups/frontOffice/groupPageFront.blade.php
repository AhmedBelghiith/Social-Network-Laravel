    ...
    <div class="theme-layout">
        ...
        <section>
            <div class="feature-photo">
                @if ($groupImage)
                    <figure><img src="{{ asset('storage/' . $group->image) }}" alt="{{ $group->name }}"
                            class="img-fluid rounded" style="height:400px;object-fit: cover;"></figure>
                @else
                    <figure><img src="{{ Vite::asset('resources/assets/images/resources/404.jpg') }}"
                            alt="Placeholder" class="img-fluid rounded" style="height:400px;object-fit: cover;">
                    </figure>
                @endif
                ...
                <div class="add-btn d-flex">
                    ...
                    <form method="POST" action="{{ route('leaveGroup', ['group' => $group]) }}">
                        @csrf
                        <button type="submit" title="Leave Group" data-ripple="">Leave Group</button>
                    </form>
                </div>
                    ...
                    <div class="row merged">
                        ...
                        <div class="col-lg-10 col-sm-9">
                            <div class="timeline-info">
                                <ul>
                                    <!-- <li class="admin-name d-flex justify-content-between"> -->
                                    <li class="admin-name">
                                        <h5>{{ $groupName }}</h5>
                                    ...
                                    <div class="loadMore">
                                        ...
                                        <div class="mb-3">
                                            <a data-toggle="modal" data-target="#myModal" class="btn btn-primary"
                                                style="color:white !important">Add Blog</a>
                                        </div>

                                        <div class="row">
                                            @if ($blogs->isEmpty())
                                                <h3 style="color:grey; text-align:center">No blogs available for this
                                                    group.</h3>
                                            @else
                                                @foreach ($blogs as $blog)
                                                    <div class="col-lg-6 col-sm-6">
                                                        <div class="g-post-classic">
                                                            <figure>
                                                                <!-- <img alt="" src="{{ Vite::asset('resources/assets/images/resources/bloglist-1.jpg') }}"> -->
                                                                @if ($blog->image)
                                                            ...
                                                            <div class="g-post-meta">
                                                                <div class="post-title">
                                                                    ...
                                                                    <p>{{ $blog->content }}</p>
                                                                    <span class="p-date">by <a href="#"
                                                                            title="">{{ $blog->author->name }}</a>
                                                                        - {{ $blog->created_at }} </span>
                                                                </div>
                                                                @if (Auth::user() && Auth::user()->id === $blog->user_id)
                                                                    <form method="POST"
                                                                        action="{{ route('deleteBlog', $blog->id) }}">
                                                                        @csrf
                                                                        @method('DELETE')
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Create Blog
                                                        </h5>
                                ...
                                <div class="col-lg-3">
                                    <aside class="sidebar static">
                                        <div class="widget friend-list stick-widget">
                                            <h4 class="widget-title">Members ({{ $followersCount }})</h4>
                                            <ul id="people-list" class="friendz-list">
                                                @foreach ($members as $member)
                                                    <li>
                                                        <figure>
                                                            <img src="{{ Vite::asset('resources/assets/images/profile.png') }}"
                                                                alt="">
                                                            <span class="status f-online"></span>
                                                        </figure>
                                                        <div class="friendz-meta">
                                                            <a href="time-line.html">{{ $member->name }}</a>
                                                            <i><a href="/cdn-cgi/l/email-protection"
                                                                    class="__cf_email__"
                                                                    data-cfemail="5f2836312b3a2d2c30333b3a2d1f38323e3633713c3032">[{{ $member->email }}]</a></i>
                                                        </div>
                                                    </li>
                                                @endforeach
                                            </ul>
