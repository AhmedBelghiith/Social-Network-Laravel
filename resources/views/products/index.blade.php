                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="forum-warper">
                                ...
                                <a class="addnewforum" href="{{ route('products.create') }}" title=""><i class="fa fa-plus"></i> Add New</a>
                            </div>
                            <div class="container">
                                <h1>Products</h1>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($product->file)
                                                <a href="{{ asset('storage/' . $product->file) }}" target="_blank"><img src="{{ asset('storage/' . $product->file) }}" alt="Image"></a>
